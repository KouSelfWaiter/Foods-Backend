            ...
            modelBuilder.Entity("Domain.Entities.Products.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1686),
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1689)
                        },
                        new
                        {
                            Id = new Guid("000ec947-d4f7-4785-9a48-d46e2a600002"),
                            CreatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1693),
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1694)
                        },
                        new
                        {
                            Id = new Guid("000ec947-d4f7-4785-9a48-d46e2a600003"),
                            CreatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1696),
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1696)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Products.Translaitons.CategoryTranslation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1824),
                            Name = "Yiyecek",
                            RelationId = new Guid("000ec947-d4f7-4785-9a48-d46e2a600001"),
                            TranslationCode = 0,
                            UpdatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1824)
                        },
                        new
                        {
                            Id = new Guid("000ec947-a4f7-4785-9a48-d46e2a600002"),
                            CreatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1828),
                            Name = "İçecek",
                            RelationId = new Guid("000ec947-d4f7-4785-9a48-d46e2a600002"),
                            TranslationCode = 0,
                            UpdatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1829)
                        },
                        new
                        {
                            Id = new Guid("000ec947-a4f7-4785-9a48-d46e2a600003"),
                            CreatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1831),
                            Name = "Tatlı",
                            RelationId = new Guid("000ec947-d4f7-4785-9a48-d46e2a600003"),
                            TranslationCode = 0,
                            UpdatedDate = new DateTime(2023, 3, 30, 13, 48, 2, 349, DateTimeKind.Utc).AddTicks(1832)
                        });
                });
